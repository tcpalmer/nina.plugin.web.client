...
npm WARN   5 more (@testing-library/react, react-dom, rsuite, rsuite-table, @rsuite/icons)
npm WARN
npm WARN Could not resolve dependency:
npm WARN peer react@"^15.3.0 || ^16.0.0-alpha" from react-virtualized@9.22.3
npm WARN node_modules/react-virtualized
npm WARN   react-virtualized@"^9.22.3" from rsuite@5.4.4
npm WARN   node_modules/rsuite
npm WARN ERESOLVE overriding peer dependency
npm WARN While resolving: react-virtualized@9.22.3
npm WARN Found: react-dom@17.0.2
npm WARN node_modules/react-dom
npm WARN   react-dom@"^17.0.2" from the root project
npm WARN   4 more (@testing-library/react, rsuite, rsuite-table, @rsuite/icons)
npm WARN
npm WARN Could not resolve dependency:
